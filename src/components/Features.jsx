      ...
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
            ...
            <BentoTilt className="bento-tilt_2">
                <div className="flex size-full flex-col bg-violet-500 justify-between p-5">
                    <h1 className="uppercase md:text-6xl text-4xl font-[zentry]
                    special-font max-w-64">More Co<b>m</b>ing So<b>o</b>n!</h1>
